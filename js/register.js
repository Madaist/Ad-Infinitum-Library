...
function createGenderInput(type, className, id, value, labelClass, labelId, divId) {
	...
	createLabel(labelClass, radioBtn.id, radioBtn.value, divId);
}
...
dupa @ trebuie sa avem litere sau cifre neaparat si apoi un punct, apoi iar litere
...
function saveUserToLocalStorage(user) {
	...
	// extragem vectorul deuser din localStorage
	...
	//dupa ce am adaugat userul, salvam iar vectorul in localStorage
